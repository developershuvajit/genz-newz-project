<?php
/**
 * GenzNewz — Reporter Notifications View
 */
...
<div class="card card-custom">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold text-dark"><i class="fa-solid fa-bell text-warning me-2"></i> সম্পাদকীয় নোটিফিকেশন</h5>
        <form action="/reporter/notifications/mark-all-read" method="POST" class="d-inline">
            <?= CSRF::field() ?>
            <button type="submit" class="btn btn-sm btn-outline-success">
                <i class="fa-solid fa-check-double me-1"></i> সব পঠিত চিহ্নিত করুন
            </button>
        </form>
    </div>
