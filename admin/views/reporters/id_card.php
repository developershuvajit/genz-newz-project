<?php
/**
 * GenzNewz — Press Accreditation ID Card Generator View
 * Dual-sided (Front & Back) CR80 Standard Layout with Barcode & Verification QR
 */
...
<style>
    ...
    /* Standard CR80 Ratio (approx 340px x 520px) */
    .id-card {
        width: 330px;
        height: 510px;
        border-radius: 14px;
    ...
    @media print {
        ...
        .btn, .admin-sidebar, .admin-navbar, footer {
...
<div class="card card-custom mb-4">
    <div class="card-body py-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            <h5 class="mb-0 fw-bold text-dark"><i class="fa-solid fa-id-badge text-success me-2"></i> অফিসিয়াল প্রেস আইডি কার্ড: <?= Helper::e($profile['full_name']) ?></h5>
            <div class="small text-muted">প্রেস কোড: <strong><?= Helper::e($profile['reporter_id']) ?></strong> &bull; মেয়াদ: <?= Helper::formatBengaliDate($profile['valid_until']) ?></div>
        </div>
        <div class="d-flex gap-2">
            ...
            <a href="/reporter/verify/<?= $profile['reporter_id'] ?>" target="_blank" class="btn btn-outline-primary">
                <i class="fa-solid fa-qrcode me-1"></i> লাইভ কিউআর ভেরিফিকেশন লিংক
            </a>
            <a href="/admin/reporters" class="btn btn-outline-secondary">
                <i class="fa-solid fa-arrow-left"></i> তালিকায় ফিরুন
            </a>
        </div>
    </div>
</div>
...
<div class="id-card-wrapper">
    ...
    <div class="id-card id-card-back">
        ...
        <div class="qr-section">
            ...
            <!-- Google Chart API for standard QR code -->
